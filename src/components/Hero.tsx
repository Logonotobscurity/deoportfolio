...
const Hero = () => {
  return (
    <section className="h-screen min-h-[700px] md:min-h-[800px] flex items-center justify-center relative overflow-hidden pt-20 md:pt-16">
      ...
      <div className="relative z-10 text-center px-4 flex flex-col items-center">
        <h1 className="text-4xl sm:text-5xl md:text-7xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-foreground to-muted-foreground pb-2">
          Adeola Daramola
        </h1>
        <p className="text-lg sm:text-xl md:text-2xl mt-4 text-primary font-semibold">
          Senior DevOps & Cloud Engineer
        </p>
        <p className="max-w-3xl mx-auto mt-4 text-muted-foreground text-sm sm:text-base">
